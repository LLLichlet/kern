...
This tutorial follows the current Kern 0.7.5 implementation. Kern is still
...
- [`library/`](../../library): the checked-out `kernlib` submodule, especially the boundaries between `base`, `rt`, and `std`.
