...
pub fn help() -> HelpDoc {
    HelpDoc::new("kernworker")
        ...
        .example(
            "kernworker release package --version v0.8.1",
...
mod tests {
    ...
    fn parses_release_package_options() {
        ...
        assert_eq!(args.version.as_deref(), Some("v0.8.1"));
    ...
    fn parses_release_bump_version() {
        ...
        assert_eq!(args.version.as_deref(), Some("0.8.1"));
        assert_eq!(args.from.as_deref(), Some("0.8.1"));
        assert!(args.check);
    }
